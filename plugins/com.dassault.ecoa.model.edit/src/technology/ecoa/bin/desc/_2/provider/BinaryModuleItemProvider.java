...
/**
 * This is the item provider adapter for a {@link technology.ecoa.bin.desc._2.BinaryModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryModuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_checksum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_checksum_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__CHECKSUM,
				 true,
				 false,
				 false,
	...
	protected void addHeapSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_heapSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_heapSize_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__HEAP_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_object_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__OBJECT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_reference_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__REFERENCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStackSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_stackSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_stackSize_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__STACK_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUserContextSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_userContextSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_userContextSize_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__USER_CONTEXT_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWarmStartContextSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryModule_warmStartContextSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_warmStartContextSize_feature", "_UI_BinaryModule_type"),
				 binPackage.Literals.BINARY_MODULE__WARM_START_CONTEXT_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryModule_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(binPackage.Literals.BINARY_MODULE__BINARY_DEPENDENCY,
