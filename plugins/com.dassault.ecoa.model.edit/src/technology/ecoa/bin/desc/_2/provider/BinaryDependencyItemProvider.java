...
/**
 * This is the item provider adapter for a {@link technology.ecoa.bin.desc._2.BinaryDependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryDependencyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryDependency_checksum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryDependency_checksum_feature", "_UI_BinaryDependency_type"),
				 binPackage.Literals.BINARY_DEPENDENCY__CHECKSUM,
				 true,
				 false,
				 false,
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryDependency_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryDependency_object_feature", "_UI_BinaryDependency_type"),
				 binPackage.Literals.BINARY_DEPENDENCY__OBJECT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns BinaryDependency.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryDependency_type") :
			getString("_UI_BinaryDependency_type") + " " + label;
	}
